				...
				<td>
					<table align="center">
						<tr>
							<td>
								<fieldset>
									<legend>Job Reference Application</legend>
									Subject:
									<input type="text" name="subject" value="Application for Job Reference "><br> <br>
									<textarea name="msg" cols="50" rows="20"></textarea> <br> <br>
									<hr>
									<input type="submit" name="reference" value="Send">
								</fieldset>
							</td>
						</tr>
					</table>
